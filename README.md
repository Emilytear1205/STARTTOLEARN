...
一點開 Screen Recorder 4 就可以看見這個操作介面，依照想要錄製的畫面可以分為全螢幕、遊戲、APP(可以訂選一個應用程式進行錄影)、自訂(固定一個錄製的範圍)、裝置(選擇一個想要的攝像頭)五種，依據用戶需求有不同的選項。在這裡還可以修改影片解析度(建議用1080要不然畫質會很差)，還有幀率，幀率30就差不多了。
